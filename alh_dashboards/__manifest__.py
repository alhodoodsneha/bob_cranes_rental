...
#############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'alh_dashboards/static/src/js/customer_dashboard.js',
            'alh_dashboards/static/src/js/employee_dashboard.js',
            'alh_dashboards/static/src/js/crm_dashboard.js',
            'alh_dashboards/static/src/xml/project_dashboard.xml',
            'alh_dashboards/static/src/xml/equipment_dashboard.xml',
            'alh_dashboards/static/src/xml/customer_dashboard.xml',
            'alh_dashboards/static/src/xml/employee_dashboard.xml',
            'alh_dashboards/static/src/xml/crm_dashboard.xml',
        ],
    },
